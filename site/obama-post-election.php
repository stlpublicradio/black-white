...
<main class="container">
  <div class="row">
    <ol class="breadcrumb col-xs-12">
      ...
      <li class="active">Obama Post Election</li>
    </ol>

    <div class="col-md-12">
      <h1>Obama Post Election <br class="hidden-sm hidden-md hidden-lg hidden-xl"><span class="date">November 2008</span></h1>
    </div>

    <div class="col-md-8">
      <p class="top">When Barack Obama was elected president he acknowledged that the historic election of a black man was only possible by his “standing on the shoulders” of those who had fought for ending discrimination and racism in previous decades and generations. Among two of the best known of this group in St. Louis were the late Margaret Bush Wilson and activist Norman Seay. Wilson served nine terms as the chairman of the national Board of Directors of the NAACP and was president of the St. Louis chapter. She was a lawyer-activist and assisted her father as he worked on ending housing discrimination. Her father’s work led to the famous 1948 Shelley vs. Kraemer Supreme Court decision, which put an end to restrictive covenants used against Black Americans. Seay was active for decades in fighting discrimination. He was jailed for ninety days for his role in 1963 demonstrations against the discriminatory hiring practices of the Jefferson Bank in St. Louis. In the days following President Obama’s election, they reflected on the history of the event.</p>
      <p>Contributors: <strong>Margaret Bush Wilson</strong> and <strong>Norman Seay</strong></p>
      <p>Originally aired November 12, 2008</p>
    </div>

    <div class="col-md-4 soundcloud-iframe">
      <iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/201295022&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
    </div>
  </div>
  <hr>
  ...
  <div class="row more-info">
    ...
    <div class="col-md-12">
      ...
      <div class="col-sm-6">
        ...
        <ul style="padding-bottom:20px;" class="top">
          <li><a href="http://www.allaboutjazz.com/articles/arti0302_01.htm" target="_blank">All About Jazz article on Black Artist Group</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="col-md-12 top" style="clear:both;">
      <div class="col-md-3 top nav-sets hidden-xs">
        <span title="Previous Story"><h3 class="hidden-sm"><a href="obama-race-speech.php"><i class="fa fa-chevron-left fa-lg" aria-label="Click for previous episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i> Previous Story</a></h3></span>
        <span title="Previous Story"><h4 class="hidden-md hidden-lg hidden-xl"><a href="obama-race-speech.php"><i class="fa fa-chevron-left fa-lg" aria-label="Click for previous episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i> Previous Story</a></h4></span>
      </div>
      ...
      <div class="col-md-3 top nav-right hidden-xs">
        <span title="Next Story"><h3 class="hidden-sm"><a href="obama-post-inauguration.php">Next Story <i class="fa fa-chevron-right fa-lg" aria-label="Click for next episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i></a></h3></span>
        <span title="Next story"><h4 class="hidden-md hidden-lg hidden-xl"><a href="obama-post-inauguration.php">Next Story <i class="fa fa-chevron-right fa-lg" aria-label="Click for next episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i></a></h4></span>
      </div>

      <div class="chevron-container">
        <div class="col-md-3 hidden-lg hidden-xl hidden-md hidden-sm top" style="float:left;">
          <br>
          <span title="Previous Story"><a href="obama-race-speech.php"><i class="fa fa-chevron-left fa-3x" style="color:#ccc; padding-left:30px;"></i></a></span>
        </div>

        <div class="col-md-3 hidden-lg hidden-xl hidden-md hidden-sm top" style="float:right;">
          <br>
          <span title="Next Story"><a href="obama-post-inauguration.php"><i class="fa fa-chevron-right fa-3x" style="color:#ccc; padding-right:30px;"></i></a></span>
        </div>
      </div>
    </div>
  </div>
