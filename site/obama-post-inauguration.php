...
<html>
<head>
  <title>Obama Post Inauguration</title>
  ...
  <div class="row more-info">
    ...
    <div class="col-md-12">
      ...
      <div class="col-sm-6">
        ...
        <ul style="padding-bottom:20px;" class="top">
          <li><a href="http://www.huffingtonpost.com/2008/03/18/obama-race-speech-read-th_n_92077.html">New York Times: Obama election victory speech transcript</a></li>
          <li><a href="http://edition.cnn.com/2008/POLITICS/11/04/obama.transcript/">CNN transcript of President Obama's election victory speech</a></li>
        </ul>

        <h3>Videos</h3>
        <ul style="padding-bottom:20px;" class="top">
          <li><a href="http://elections.nytimes.com/2008/results/president/speeches/obama-victory-speech.html#">New York Times: Obama election victory speech</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="col-md-12 top" style="clear:both;">
      <div class="col-md-3 top nav-sets hidden-xs">
        <span title="Previous Story"><h3 class="hidden-sm"><a href="obama-post-election.php"><i class="fa fa-chevron-left fa-lg" aria-label="Click for previous episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i> Previous Story</a></h3></span>
        <span title="Previous Story"><h4 class="hidden-md hidden-lg hidden-xl"><a href="obama-post-election.php"><i class="fa fa-chevron-left fa-lg" aria-label="Click for previous episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i> Previous Story</a></h4></span>
      </div>
      ...
      <div class="col-md-3 top nav-right hidden-xs">
        <span title="Next Story"><h3 class="hidden-sm"><a href="white-perception.php">Next Story <i class="fa fa-chevron-right fa-lg" aria-label="Click for next episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i></a></h3></span>
        <span title="Next story"><h4 class="hidden-md hidden-lg hidden-xl"><a href="white-perception.php">Next Story <i class="fa fa-chevron-right fa-lg" aria-label="Click for next episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i></a></h4></span>
       </div>

       <div class="chevron-container">
        <div class="col-md-3 hidden-lg hidden-xl hidden-md hidden-sm top" style="float:left;">
          <br>
          <span title="Previous Story"><a href="obama-post-election.php"><i class="fa fa-chevron-left fa-3x" style="color:#ccc; padding-left:30px;"></i></a></span>
        </div>

        <div class="col-md-3 hidden-lg hidden-xl hidden-md hidden-sm top" style="float:right;">
          <br>
          <span title="Next Story"><a href="white-perception.php"><i class="fa fa-chevron-right fa-3x" style="color:#ccc; padding-right:30px;"></i></a></span>
        </div>
      </div>
    </div>
  </div>
