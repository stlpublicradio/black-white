...
<html>
<head>
  <title>Impact of OBama's Race Speech on Campaign</title>
...
<main class="container">
  <div class="row">
    <ol class="breadcrumb col-xs-12">
      ...
      <li class="active">Impact of OBama's Race Speech on Campaign</li>
    </ol>

    <div class="col-md-12">
      <h1>Impact of Obama's Race Speech on Campaign <br class="hidden-sm hidden-md hidden-lg hidden-xl"><span class="date">2008</span></h1>
    </div>

    <div class="col-md-8">
      <p class="top">During the 2008 presidential campaign, then Senator Barack Obama delivered what was largely considered his most important speech of the campaign, and one of the most significant speeches ever on the subject of race relations. He was responding to comments made by his long-time pastor, Rev. Jeremiah Wright condemning what he called “racist America.” Wright suggested that racism led to the September 11 attack at the World Trade Center. Because he was an informal adviser to the Obama campaign, Wright’s comments raised questions about candidate Obama’s own attitude on race. Sen. Obama delivered his response, titled <em>A More Perfect Union</em> at Philadelphia’s Constitution Center. The candidate discussed racial tension, white privilege, and black anger. He appealed for America and Americans to “come together” to confront and solve the major problems facing <em>all</em> Americans. The speech launched a national dialogue on race. In St. Louis, the polarization of races had long been acknowledged by both black and white people. Part of the local dialogue was conducted by Lewis Reed, President of the Board of Aldermen, Rabbi Mark Shook of Temple Israel, and Reverend Earl Nance, Jr. of the Greater Mt. Carmel Baptist Church.</p>
      <p>Contributors: <strong>Lewis Reed</strong>, <strong>Rabbi Mark Shook</strong>, and <strong>Reverend Earl Nance, Jr.</strong></p>
    </div>

    <div class="col-md-4 soundcloud-iframe">
      <iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/201295023&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
    </div>
  </div>
  <hr>
  ...
  <div class="row more-info">
    ...
    <div class="col-md-12">
      <div class="col-sm-6 bw-photos">
        <h3>Images</h3>
        <a data-flickr-embed="true"  href="https://www.flickr.com/photos/21486668@N03/albums/72157668363753194" title="Obama Election"><img src="https://c7.staticflickr.com/9/8282/27795133574_b01c95ecff_o.jpg" width="273" height="185" alt="Obama Election"></a><script async src="//embedr.flickr.com/assets/client-code.js" charset="utf-8"></script>
      </div>

      <div class="col-sm-6">
        <h3>Links</h3>
        <ul style="padding-bottom:20px;" class="top">
          <li><a href="http://www.huffingtonpost.com/2008/03/18/obama-race-speech-read-th_n_92077.html"><em>Huffington Post</em>&nbsp;on Obama speech with video</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="col-md-12 top" style="clear:both;">
      <div class="col-md-3 top nav-sets hidden-xs">
        <span title="Previous Story"><h3 class="hidden-sm"><a href="education.php"><i class="fa fa-chevron-left fa-lg" aria-label="Click for previous episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i> Previous Story</a></h3></span>
        <span title="Previous Story"><h4 class="hidden-md hidden-lg hidden-xl"><a href="education.php"><i class="fa fa-chevron-left fa-lg" aria-label="Click for previous episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i> Previous Story</a></h4></span>
      </div>
      ...
      <div class="col-md-3 top nav-right hidden-xs">
        <span title="Next Story"><h3 class="hidden-sm"><a href="obama-post-election.php">Next Story <i class="fa fa-chevron-right fa-lg" aria-label="Click for next episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i></a></h3></span>
        <span title="Next story"><h4 class="hidden-md hidden-lg hidden-xl"><a href="obama-post-election.php">Next Story <i class="fa fa-chevron-right fa-lg" aria-label="Click for next episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i></a></h4></span>
      </div>

      <div class="chevron-container">
        <div class="col-md-3 hidden-lg hidden-xl hidden-md hidden-sm top" style="float:left;">
          <br>
          <span title="Previous Story"><a href="education.php"><i class="fa fa-chevron-left fa-3x" style="color:#ccc; padding-left:30px;"></i></a></span>
        </div>

        <div class="col-md-3 hidden-lg hidden-xl hidden-md hidden-sm top" style="float:right;">
          <br>
          <span title="Next Story"><a href="obama-post-election.php"><i class="fa fa-chevron-right fa-3x" style="color:#ccc; padding-right:30px;"></i></a></span>
        </div>
      </div>
    </div>
  </div>
