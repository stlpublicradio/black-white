...
<main class="container">
  <div class="row">
    <ol class="breadcrumb col-xs-12">
      ...
      <li class="active">Hardships for African-American Girls</li>
    </ol>

    <div class="col-md-12">
      <h1>Hardships for African-American Girls <br class="hidden-sm hidden-md hidden-lg hidden-xl"><span class="date">2008</span></h1>
    </div>

    <div class="col-md-8">
      <p class="top">The life of young African-Americans in poor urban neighborhoods can be more difficult than their middle class Caucasian or African -American counterparts know. Violence and drugs are key components. Parental supervision is often lacking. For African-American girls, circumstances conspire to keep them mired in an ugly cycle. University of Missouri criminologist Jody Miller has done extensive research into the circumstances that lead so many of these young women into the trap of that cycle which she detailed in her book <em><a href="http://books.google.com/books?id=BrEpcxEbsQcC&printsec=frontcover&dq=African+american+girls&hl=en&ei=h4JMTaLwEemK4gaAp4WWDA&sa=X&oi=book_result&ct=result&resnum=3&sqi=2&ved=0CEoQ6AEwAg#v=onepage&q&f=false">Getting Played: African American Girls, Urban Inequality and Gendered Violence</a></em>.</p>
      <p>Contributors: <strong>Jody Miller</strong></p>
      <p>Originally aired August 27, 2008</p>
    </div>

    <div class="col-md-4 soundcloud-iframe">
      <iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/201295026&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
    </div>
  </div>
  <hr>
  ...
  <div class="row more-info">
    ...
    <div class="col-md-12">
      <div class="col-sm-6 bw-photos">
        <h3>Images</h3>
        <a data-flickr-embed="true"  href="https://www.flickr.com/photos/21486668@N03/albums/72157671272490785" title="The Hardships of African-American Girls"><img src="https://c4.staticflickr.com/9/8583/28333358651_787fb566ec_o.jpg" width="333" height="500" alt="The Hardships of African-American Girls"></a><script async src="//embedr.flickr.com/assets/client-code.js" charset="utf-8"></script>
      </div>

      <div class="col-sm-6">
        <h3>Links</h3>
        <ul style="padding-bottom:20px;" class="top">
          <li><a href="https://books.google.com/books?id=BrEpcxEbsQcC&printsec=frontcover&dq=African+american+girls&hl=en&ei=h4JMTaLwEemK4gaAp4WWDA&sa=X&oi=book_result&ct=result&resnum=3&sqi=2&ved=0CEoQ6AEwAg#v=onepage&q&f=false" target="_blank"><em>Getting Played</em></a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="col-md-12 top" style="clear:both;">
      <div class="col-md-3 top nav-sets hidden-xs">
        <span title="Previous Story"><h3 class="hidden-sm"><a href="n-word.php"><i class="fa fa-chevron-left fa-lg" aria-label="Click for previous episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i> Previous Story</a></h3></span>
        <span title="Previous Story"><h4 class="hidden-md hidden-lg hidden-xl"><a href="n-word.php"><i class="fa fa-chevron-left fa-lg" aria-label="Click for previous episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i> Previous Story</a></h4></span>
      </div>
      ...
      <div class="col-md-3 top nav-right hidden-xs">
        <span title="Next Story"><h3 class="hidden-sm"><a href="education.php">Next Story <i class="fa fa-chevron-right fa-lg" aria-label="Click for next episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i></a></h3></span>
        <span title="Next story"><h4 class="hidden-md hidden-lg hidden-xl"><a href="education.php">Next Story <i class="fa fa-chevron-right fa-lg" aria-label="Click for next episode" style="color:#ccc; padding-left:.25em; padding-right:.25em;"></i></a></h4></span>
      </div>

      <div class="chevron-container">
        <div class="col-md-3 hidden-lg hidden-xl hidden-md hidden-sm top" style="float:left;">
          <br>
          <span title="Previous Story"><a href="n-word.php"><i class="fa fa-chevron-left fa-3x" style="color:#ccc; padding-left:30px;"></i></a></span>
        </div>

        <div class="col-md-3 hidden-lg hidden-xl hidden-md hidden-sm top" style="float:right;">
          <br>
          <span title="Next Story"><a href="education.php"><i class="fa fa-chevron-right fa-3x" style="color:#ccc; padding-right:30px;"></i></a></span>
        </div>
      </div>
    </div>
  </div>
